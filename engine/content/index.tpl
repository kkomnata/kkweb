		...
		<table id="chat-controls">
			<tr>
				<td id="chat-settings-button" onclick="toggleSettings()">
					<svg id="chat-settings-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	 viewBox="0 0 487.7 487.7" xml:space="preserve">
					<g>
						<g>
							<path d="M485.6,304c-2.8-6.7-8-11.9-14.7-14.7l-25.7-10.5c4.1-23.2,4.1-46.7,0-69.8l25.6-10.6c6.7-2.8,11.9-8,14.6-14.7
					...
					<g>
						<g>
							<path d="M336.6,205.4c-15.6-37.7-52-62.1-92.8-62.1c-13.2,0-26.1,2.6-38.4,7.7c-51.2,21.2-75.6,80.1-54.4,131.2
